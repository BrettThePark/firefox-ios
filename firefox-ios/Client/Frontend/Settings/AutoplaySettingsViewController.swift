...
class AutoplaySettingsViewController: SettingsTableViewController {
    ...
    override func generateSettings() -> [SettingSection] {
        ...
        let allowAudioAndVideo = CheckmarkSetting(
            ...
            isChecked: { [weak self] in self?.currentChoice == AutoplayAction.allowAudioAndVideo },
        ...
        let blockAudio = CheckmarkSetting(
            ...
            isChecked: { [weak self] in self?.currentChoice == AutoplayAction.blockAudio },
            onChecked: { [weak self] in
        ...
        let blockAudioAndVideo = CheckmarkSetting(
            ...
            isChecked: { [weak self] in self?.currentChoice == AutoplayAction.blockAudioAndVideo },
            onChecked: { [weak self] in
