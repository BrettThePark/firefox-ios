...
class NewTabContentSettingsViewController: SettingsTableViewController {
    ...
    override func generateSettings() -> [SettingSection] {
        ...
        let onFinished = { [weak self] in
            guard let self, let currentChoice = self.currentChoice else { return }
        ...
        let showTopSites = CheckmarkSetting(
            ...
            isChecked: { [weak self] in self?.currentChoice == NewTabPage.topSites },
        ...
        let showBlankPage = CheckmarkSetting(
            ...
            isChecked: { [weak self] in self?.currentChoice == NewTabPage.blankPage },
            onChecked: { [weak self] in
